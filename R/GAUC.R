#' A function to estimate the GAUC from a time series of spawner counts. See Askey et al. in review CJFAS.
#'
...
#' #Note the All_cnts data set already has assumed 0s intergrate, so we filter those out for the example.
#'
